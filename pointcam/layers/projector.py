...
# source: https://github.com/bytedance/ibot/blob/main/models/head.py
...
if __name__ == "__main__":
    head = iBOTHead(384, 512, hidden_dim=768, bottleneck_dim=128, shared_head=True)
    print(head)

    x1 = torch.randn(16, 64 + 1, 384)
    x2 = torch.randn(16, 64 + 1, 384)

    y1_cls, y1_patches = head(x1)
    y2_cls, y2_patches = head(x2)
    print(y1_cls.shape, y1_patches.shape)
